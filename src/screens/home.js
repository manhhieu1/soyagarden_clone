...
export default function home({route, navigation}) {
  ...
  const renderItem1 = ({item}) => (
    <TouchableOpacity
      style={{marginLeft: 15, marginRight: 30}}
      onPress={() => navigation.navigate(`Voucher${item.id + 1}`)}>
      <View style={{width: 200}}>
        <View style={{}}>
          <Image style={styles.imgStyle} source={{uri: item.photo[item.id]}} />
        </View>
        <View style={{marginTop: 10}}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('napdau')}>
            <View>
              <Image
                ...
                source={require('../images/napdau.png')}
              />
              <Text> Nạp đậu</Text>
            </View>
          </TouchableOpacity>
        ...
        <View style={{backgroundColor: '#EFEFEF'}}>
          ...
          <View style={{backgroundColor: 'white', marginTop: 5}}>
            <View
              ...
              <TouchableOpacity
                onPress={() =>
                  Linking.openURL('https://soyagarden.com/khuyen-mai/')
                }>
                <SimpleLineIcons
                  name="arrow-right"
                  size={15}
          ...
          <View
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() =>
                  Linking.openURL('https://soyagarden.com/tin-tuc/')
                }>
                <SimpleLineIcons
                  name="arrow-right"
                  size={15}
